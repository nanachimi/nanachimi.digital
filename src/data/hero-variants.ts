export interface HeroStat {
  value: string;
  label: string;
  animated?: { target: number; suffix?: string }; // If set, uses AnimatedCounter
}
...
export interface HeroVariant {
  ...
  middleStat?: HeroStat; // A/B testable — replaces the middle stat card
}
...
export const HERO_VARIANTS: HeroVariant[] = [
  {
    ...
    middleStat: { value: "Ab 299 €", label: "Ihre Lösung" },
  },
  {
    id: "sorglos",
  ...
  },
  {
    ...
    primaryCta: { label: "In 48h online — jetzt starten", href: "/onboarding" },
    secondaryCta: { label: "Kostenlos beraten lassen", href: "/kontakt" },
    // This variant keeps the old stat for A/B comparison
    middleStat: { value: "", label: "Produkte gebaut", animated: { target: 5 } },
  },
];
